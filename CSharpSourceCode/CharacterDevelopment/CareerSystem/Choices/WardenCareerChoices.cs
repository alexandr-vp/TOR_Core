...
namespace TOR_Core.CharacterDevelopment.CareerSystem.Choices
{
    public class WardenCareerChoices(CareerObject id) : TORCareerChoicesBase(id)
    {
        ...
        protected override void InitializePassives()
        {
            ...
            _wardenOfWydriothPassive2.Initialize(CareerID, "{=warden_of_wydrioth_passive1_str}10% extra range damage.", "WardenOfWydrioth", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.Damage, new DamageProportionTuple(DamageType.Physical, 10), AttackTypeMask.Ranged,
            ...
            _wardenOfWydriothPassive4.Initialize(CareerID, "{=martialle_passive3_str}All troops gain 10% extra damage with bows.", "WardenOfWydrioth", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.TroopDamage, new DamageProportionTuple(DamageType.Physical,10), AttackTypeMask.All, (attacker, victim, mask) => mask  == AttackTypeMask.Ranged && attacker.Character.IsElf()));
            ...
            _wardenOfTorgovannPassive3.Initialize(CareerID, "{=warden_of_atylwyth_passive2_str}Increases Hitpoints by 25.", "WardenOfTorgovann", false, ChoiceType.Passive, null,new CareerChoiceObject.PassiveEffect(25, PassiveEffectType.Health));
            ...
            _wardenOfAtylwythPassive2.Initialize(CareerID, "{=warden_of_atylwyth_passive3_str}Eternal guard troops gain 15% physical resistance.", "WardenOfAtylwyth", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.TroopResistance, new DamageProportionTuple(DamageType.Physical, 15), AttackTypeMask.All, 
                (attacker, victim, mask) => victim.BelongsToMainParty() && victim.Character.IsElf() && victim.Character.StringId.Contains("eternal")));
            _wardenOfAtylwythPassive3.Initialize(CareerID, "{=warden_of_atylwyth_passive2_str}For every Glade Captain in your party gain 10 party size.", "WardenOfAtylwyth", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(10, PassiveEffectType.Special));

            _wardenOfAtylwythPassive4.Initialize(CareerID, "{=warden_of_atylwyth_passive4_str}All Elves receive 20 bonus points in their  bow skill.", "WardenOfAtylwyth", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(20, new List<string>(){nameof(DefaultSkills.Polearm)}, characterObject => characterObject.IsElf()));
